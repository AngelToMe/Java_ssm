									...
									<c:forEach items="${pageInfo.list}" var="permission">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${permission.id}" class="btn bg-olive btn-xs">添加用户</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="i">
									<li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=${i}&size=${pageInfo.pageSize}">${i}</a></li>
								</c:forEach>
