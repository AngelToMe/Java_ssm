...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
								...
								<div class="pull-left">
									<div class="form-group form-inline">
										<div class="btn-group">
											...
											<button type="button" class="btn btn-default" title="删除" onclick="delUser()"><i
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="i">
									<li><a href="${pageContext.request.contextPath}/user/findAll.do?page=${i}&size=${pageInfo.pageSize}">${i}</a></li>
								</c:forEach>
		...
		<script>
			...
			function delUser() {
				if ($("input[name='ids']").is(":checked")){ // 如果选中的情况
					$("#user_form").submit();
				}else{
					alert("未选中")
				}
