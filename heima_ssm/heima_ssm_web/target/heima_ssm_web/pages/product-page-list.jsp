                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="删除" onclick="delSelect()"><i
                            ...
                            <thead>
                                <tr>
                                    <th class="" style="padding-right:0px;">
                                        <input type="checkbox" name="allSelect" class="icheckbox_square-blue" >
                                    </th>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${pageInfo.pages}" var="i">
                                <li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${i}&size=${pageInfo.pageSize}">${i}</a></li>
                            </c:forEach>
...
<script type="text/javascript">
    ...
    // 删除选中
    function delSelect() {
        if ($("input[name='id']").is(":checked")){ // 如果选中的情况
            $("#form").submit();
        }else{
            alert("未选中")
        }
